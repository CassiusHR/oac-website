...
const Navbar = () => {
  ...
  return (
    <nav className="main-nav">
      ...
      <ul>
        <NavLink to="/" exact activeClassName="active"><li className="nav-link">Inicio</li></NavLink>
        <NavLink to="/blog" activeClassName="active"><li className="nav-link">Blog</li></NavLink>
        <NavLink to="/quienes-somos" activeClassName="active"><li className="nav-link">Quienes somos</li></NavLink>
        <NavLink to="/cartelera" activeClassName="active"><li className="nav-link">Cartelera</li></NavLink>
        <NavLink to="/contacto" activeClassName="active"><li className="nav-link">Contacto</li></NavLink>
      </ul>
